<script>
    ...
    async function getUserConfig() {
        configLoading = true;
        try {
            userConfig = await devhubActor.get_user_config(activeConfigIndex);
    ...
    async function onNewCanisterFollowed(event) {
        ...
        try {
            // devhubActor = await getActorFromCanisterId(activeCanisterId, agent);
            let result = await devhubActor.cache_canister_config(activeConfigIndex, newCfg);
    ...
    async function onUpdateUIConfig(newUIConfig) {
        ...
        try {
            ...
            await devhubActor.cache_ui_config(activeConfigIndex, JSON.stringify(newUIConfig));
